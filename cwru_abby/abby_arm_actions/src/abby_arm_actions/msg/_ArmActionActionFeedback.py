"""autogenerated by genpy from abby_arm_actions/ArmActionActionFeedback.msg. Do not edit."""
import sys
...
class ArmActionActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "abby_arm_actions/ArmActionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','abby_arm_actions/ArmActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArmActionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = abby_arm_actions.msg.ArmActionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = abby_arm_actions.msg.ArmActionFeedback()
