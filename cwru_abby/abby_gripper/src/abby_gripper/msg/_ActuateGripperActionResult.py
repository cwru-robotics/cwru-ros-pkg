"""autogenerated by genpy from abby_gripper/ActuateGripperActionResult.msg. Do not edit."""
import sys
...
class ActuateGripperActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "abby_gripper/ActuateGripperActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','abby_gripper/ActuateGripperResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActuateGripperActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = abby_gripper.msg.ActuateGripperResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = abby_gripper.msg.ActuateGripperResult()
