...
void harlie_obstacle_planner_Callback(const nav_msgs::GridCells& msg)
{
...
int main(int argc, char** argv)
{
  ...
  ros::NodeHandle n;
  ros::Subscriber harlie_obstacle_planner_sub = n.subscribe("map", 2, harlie_obstacle_planner_Callback);
