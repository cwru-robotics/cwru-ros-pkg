// example_robot_interface.h header file //
// wsn; march, 2015
// include this file in "example_robot_interface.cpp"
...
#ifndef EXAMPLE_ROBOT_INTERFACE_H_
#define EXAMPLE_ROBOT_INTERFACE_H_
